...
import InfoInput from './Components/InfoInput/Container';
import ItemTable from './Components/ItemTable/Container';
...
angular.module('invoicing', [])
	...
	.component('infoInput', react2angular(InfoInput, ['label', 'type', 'id', 'info', 'name']))
	...
	.controller('InvoiceCtrl', ['$scope', '$http', 'LocalStorage', 'Currency',
		function ($scope, $http, LocalStorage, Currency) {//
